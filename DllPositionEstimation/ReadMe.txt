========================================================================
    MFC 라이브러리 : DllPositionEstimation 프로젝트 개요
========================================================================
...
이 파일에는 DllPositionEstimation DLL을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

DllPositionEstimation.vcxproj
...
DllPositionEstimation.vcxproj.filters
...
DllPositionEstimation.h
    해당 DLL의 기본 헤더 파일이며,  CDllPositionEstimationApp
    클래스가 선언되어 있습니다.

DllPositionEstimation.cpp
    기본 DLL 소스 파일입니다.  CDllPositionEstimationApp 클래스가 포함되어 있습니다.

DllPositionEstimation.rc
    프로그램에서 사용하는 모든 Microsoft Windows 리소스의 목록입니다.
    여기에는 RES 하위 디렉터리에 저장된 아이콘, 비트맵 및 커서가
    포함됩니다.  이 파일은 Microsoft Visual C++에서
    직접 편집할 수 있습니다.

res\DllPositionEstimation.rc2
    이 파일에는 Microsoft Visual C++ 이외의 다른 도구에서 편집한 리소스가
    포함되어 있습니다.  리소스 편집기로 편집할 수 없는 모든 리소스는
    이 파일에 넣어야 합니다.

DllPositionEstimation.def
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 DllPositionEstimation.pch와
